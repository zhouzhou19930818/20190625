...
const types = {
    ...
    CHANGE_IS_EXPEND_CONTENT1: 'CHANGE_IS_EXPEND_CONTENT1',
...
const actions = {
    ...
    changeIsExpendContent1: (value) => ({
        type: types.CHANGE_IS_EXPEND_CONTENT1,
        value: value
    }),
...
const reducer = (state = initState, actions) => {
    switch (actions.type) {
        ...
        case types.CHANGE_IS_EXPEND_CONTENT1:
        console.log(actions)
