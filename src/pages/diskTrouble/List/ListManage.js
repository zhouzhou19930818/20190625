...
import { computedStyle, debounce, getNumber } from "src/tools/utils";
...
class ListManage extends Component {
    ...
    mouseEvent = () => {
        ...
        const header = document.getElementById('disk-dragHeader');
        const container = document.getElementsByClassName('disk-drag-container')[0];
                ...
                <ContainerBody className="disk"
                    ...
                    <div className="drag-container disk-drag-container">
                        ...
                        <div className="drag-content disk-drag-content" id="disk-dragContent">
                            ...
                            <div className="disk-drag-steps-container">
