...
let breadcrumb; // 存储dom元素

export function showOrHideCrumb(scrollTop) {
    const HIDECLASSNAME = 'hide';
    !breadcrumb && (breadcrumb = document.getElementsByClassName('sd-breadcrumb-wrapper')[0]);
    const classList = breadcrumb.classList;
    scrollTop > 1
        ? !classList.value.includes(HIDECLASSNAME) && breadcrumb.classList.add(HIDECLASSNAME)
